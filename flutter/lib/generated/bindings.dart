...
class RustLibBindings {
  ...
  void get_all_expiries(int task_id, FfiCallback callback) {
    return _get_all_expiries(task_id, callback);
  }

  late final _get_all_expiriesPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Uint64, FfiCallback)>>(
        'get_all_expiries',
      );
  late final _get_all_expiries = _get_all_expiriesPtr
      .asFunction<void Function(int, FfiCallback)>();

  void get_channel_headers(
    int task_id,
    FfiCallback callback,
    ffi.Pointer<ffi.Uint8> ptr,
    int len,
