...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1235363224;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        2 => wire__crate__api__sql__delete_database_impl(port, ptr, rust_vec_len, data_len),
        3 => wire__crate__api__sql__delete_source_impl(port, ptr, rust_vec_len, data_len),
        4 => wire__crate__api__utils__download_impl(port, ptr, rust_vec_len, data_len),
        5 => wire__crate__api__sql__favorite_channel_impl(port, ptr, rust_vec_len, data_len),
        6 => wire__crate__api__settings__get_default_record_path_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        7 => wire__crate__api__sql__get_enabled_sources_impl(port, ptr, rust_vec_len, data_len),
        8 => wire__crate__api__xtream__get_episodes_impl(port, ptr, rust_vec_len, data_len),
        9 => wire__crate__api__m3u__get_m3u8_from_link_impl(port, ptr, rust_vec_len, data_len),
        10 => wire__crate__api__settings__get_settings_impl(port, ptr, rust_vec_len, data_len),
        11 => wire__crate__api__xtream__get_short_epg_impl(port, ptr, rust_vec_len, data_len),
        12 => wire__crate__api__sql__get_sources_impl(port, ptr, rust_vec_len, data_len),
        13 => wire__crate__api__xtream__get_xtream_impl(port, ptr, rust_vec_len, data_len),
        14 => wire__crate__api__sql__insert_channel_headers_impl(port, ptr, rust_vec_len, data_len),
        15 => wire__crate__api__m3u__read_m3u8_impl(port, ptr, rust_vec_len, data_len),
        16 => wire__crate__api__utils__refresh_all_impl(port, ptr, rust_vec_len, data_len),
        17 => wire__crate__api__utils__refresh_source_impl(port, ptr, rust_vec_len, data_len),
        18 => wire__crate__api__sql__search_impl(port, ptr, rust_vec_len, data_len),
        19 => wire__crate__api__sql__source_name_exists_impl(port, ptr, rust_vec_len, data_len),
        20 => wire__crate__api__settings__update_settings_impl(port, ptr, rust_vec_len, data_len),
        21 => wire__crate__api__sql__update_source_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
